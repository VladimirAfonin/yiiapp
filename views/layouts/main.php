...
<!--    второй способ подключения набора js файлов -->
<!--    --><?php //$this->registerJsFile('js/html5shiv.js', ['position' => View::POS_HEAD, 'condition' => 'lte IE9']) ?>
    <!--/head-->
</head>
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <?php if(!Yii::$app->user->isGuest) : ?>
                                <li><a href="#"><i class="fa fa-user"></i> <?= Url::to(['/site/logout']) ?></a></li>
                                <li><a href="<?= Url::to(['/site/logout']) ?>"><i class="fa fa-user"></i> Logout</a></li>
                            <?php endif; ?>
